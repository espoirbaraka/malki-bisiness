 <aside class="main-sidebar">
   <section class="sidebar">
     ...
     <ul class="sidebar-menu" data-widget="tree">
       ...
       <li><a href="approv.php"><i class="fa fa-shopping-basket"></i> <span>Stock</span></a></li>
       <li><a href="paiement.php"><i class="fa fa-money"></i> <span>Commandes</span></a></li>
       ...
       <li class="treeview">
         ...
         <ul class="treeview-menu">
           ...
           <li><a href="user.php"><i class="fa fa-circle-o"></i> Utilisateurs</a></li>
             <li><a href="publication.php"><i class="fa fa-circle-o"></i> Publication slide</a></li>
         </ul>
       </li>
     </ul>
   </section>
